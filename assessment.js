...
for(var s in snake){
	s.split('')[0]==="s"?snake[s]="s":undefined;
}
// console.log(snake);
...
var beef={color:"red",taste:"delicious"};
...
makeChatMessage("hello there!", "mike");
